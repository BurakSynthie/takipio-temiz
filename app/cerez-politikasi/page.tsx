...
const sections = [
  { title: 'Çerez Nedir?', text: 'Çerezler, web sitesini ziyaret ettiğinizde tarayıcınıza kaydedilen küçük veri dosyalarıdır. Oturum, güvenlik ve deneyim iyileştirme amacıyla kullanılabilir.' },
  { title: 'Kullanılan Çerez Türleri', text: 'Takipio; oturum yönetimi, beni hatırla, güvenlik, performans ve kullanıcı tercihleri için gerekli çerezleri kullanabilir.' },
  { title: 'Zorunlu Çerezler', text: 'Oturum açma, güvenli giriş, kullanıcı doğrulama ve panelin temel çalışması için zorunlu çerezler kullanılabilir.' },
  { title: 'Tercihlerin Yönetimi', text: 'Tarayıcı ayarlarından çerezleri silebilir veya engelleyebilirsiniz. Ancak bazı çerezlerin kapatılması panelin çalışmasını etkileyebilir.' },
  { title: 'Güncellemeler', text: 'Çerez politikası, platform özellikleri geliştikçe güncellenebilir.' }
];
...
export default function Page() {
  return (
    <LegalPageTemplate
      ...
      description='Takipio web sitesi ve panelinde kullanılan çerezler hakkında bilgilendirme sağlar.'
      sections={sections}
    />
  );
}
