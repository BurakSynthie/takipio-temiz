const items = [{"title": "Firma Bilgileri", "description": "Logo, unvan, adres ve iletişim ayarları", "status": "Hazır"}, {"title": "Kullanıcı Rolleri", "description": "Admin, ekip üyesi ve muhasebe rolleri", "status": "Yakında"}];
    ...
    <section>
      <div className="mb-8 flex flex-col gap-4 md:flex-row md:items-end md:justify-between">
        <div>
          ...
          <p className="mt-2 text-slate-500">Firma bilgileri, kullanıcı rolleri ve panel tercihleri.</p>
        </div>
