const items = [{"title": "Premium Kahve", "description": "SKU: TKP-001 · Stok: 42", "status": "Aktif"}, {"title": "Oto Kokusu", "description": "SKU: TKP-003 · Stok: 86", "status": "Aktif"}];
  ...
  return (
    <section>
      <div className="mb-8 flex flex-col gap-4 md:flex-row md:items-end md:justify-between">
        <div>
          <h1 className="text-3xl font-black tracking-tight text-slate-950">Ürünler</h1>
          <p className="mt-2 text-slate-500">Ürün kartları, SKU, varyant ve QR bağlantılarını yönet.</p>
        </div>
