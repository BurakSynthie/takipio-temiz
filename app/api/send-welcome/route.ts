          ...
          <tr>
            <td align="center">
              <table width="100%" cellpadding="0" cellspacing="0" role="presentation" style="max-width:650px;background:#ffffff;border-radius:30px;overflow:hidden;border:1px solid #d8e9ff;box-shadow:0 26px 70px rgba(9,30,66,0.13);">
                <tr>
                  <td style="padding:30px;background:linear-gradient(135deg,#06101f 0%,#092d73 50%,#0b63ff 100%);">
                    ...
                    <table width="100%" cellpadding="0" cellspacing="0" role="presentation">
                      <tr>
                        <td style="padding:14px 0;border-bottom:1px solid #edf3fb;">
                          <table width="100%" cellpadding="0" cellspacing="0" role="presentation">
                            <tr>
                              <td width="42" valign="top"><div style="width:34px;height:34px;border-radius:12px;background:#e8f2ff;color:#0b63ff;text-align:center;line-height:34px;font-size:17px;font-weight:900;">1</div></td>
                              <td valign="top">
                      ...
                      <tr>
                        <td style="padding:14px 0;border-bottom:1px solid #edf3fb;">
                          <table width="100%" cellpadding="0" cellspacing="0" role="presentation">
                            <tr>
                              <td width="42" valign="top"><div style="width:34px;height:34px;border-radius:12px;background:#e8f2ff;color:#0b63ff;text-align:center;line-height:34px;font-size:17px;font-weight:900;">2</div></td>
                              <td valign="top">
                      ...
                      <tr>
                        <td style="padding:14px 0;">
                          <table width="100%" cellpadding="0" cellspacing="0" role="presentation">
                            <tr>
                              <td width="42" valign="top"><div style="width:34px;height:34px;border-radius:12px;background:#e8f2ff;color:#0b63ff;text-align:center;line-height:34px;font-size:17px;font-weight:900;">3</div></td>
                              <td valign="top">
                ...
                <tr>
                  <td style="padding:24px 30px 30px;background:#ffffff;">
                    <div style="padding:24px;border-radius:26px;background:linear-gradient(180deg,#f8fbff,#eef6ff);border:1px solid #dbeafe;text-align:center;">
                      <div style="font-size:18px;font-weight:900;color:#06101f;letter-spacing:-0.4px;">
                        Lansman yaklaştığında seni bilgilendireceğiz.
                      </div>
                      <div style="margin-top:9px;font-size:14px;line-height:1.6;color:#667085;">
                        Bu sırada Takipio gelişmelerini Instagram’dan takip edebilirsin.
                      </div>
                      <div style="margin-top:20px;">
                        <a href="https://takipio.com" style="display:inline-block;background:#0b63ff;color:#ffffff;text-decoration:none;font-size:15px;font-weight:900;padding:14px 20px;border-radius:14px;box-shadow:0 14px 28px rgba(11,99,255,0.22);margin:0 5px 10px;">Siteyi Gör</a>
...
export async function POST(request: Request) {
  try {
    ...
    if (!resendResponse.ok) {
      return NextResponse.json(
        { ok: false, message: "Mail gönderilemedi.", details: resendResult },
